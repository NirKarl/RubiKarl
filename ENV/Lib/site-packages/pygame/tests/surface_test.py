...
if is_pygame_pkg:
    ...
    from impTest import test_utils
    from impTest.test_utils import example_path
    try:
        from impTest.test_utils.arrinter import *
    except ImportError:
        pass
import pygame
...
class SurfaceGetBufferTest (unittest.TestCase):
    ...
    if pygame.HAVE_NEWBUF:
        ...
        if is_pygame_pkg:
            ...
            from impTest.test_utils import buftools
